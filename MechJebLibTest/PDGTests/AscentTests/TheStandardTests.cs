...
namespace MechJebLibTest.PDGTests.AscentTests
{
    public class TheStandardTests
    {
        ...
        public void TheStandardGuidedUpperPeriapsis()
        {
            ...
            pdg.PrimalFeasibility.ShouldBeZero(1e-9);
            solution.Vgo(t0).ShouldEqual(9664.3818394067875, 1e-7);
            ...
            ascent2.Run();
            Optimizer      pdg2     = ascent2.GetOptimizer() ?? throw new Exception("null optimizer");
            using Solution solution2 = pdg2.Solution ?? throw new Exception("null solution");

            pdg2.PrimalFeasibility.ShouldBeZero(1e-9);
            solution2.Vgo(t0).ShouldEqual(9664.3847873128088, 1e-7);
            ...
            ascent3.Run();
            Optimizer      pdg3     = ascent3.GetOptimizer() ?? throw new Exception("null optimizer");
            using Solution solution3 = pdg3.Solution ?? throw new Exception("null solution");

            pdg3.PrimalFeasibility.ShouldBeZero(1e-9);
            solution3.Vgo(t0).ShouldEqual(9664.3847735432391, 1e-7);
            ...
            solution.Tgo(solution.T0, 2).ShouldEqual(235.03888133255938, 1e-7);
            ...
            solution.Vgo(t0).ShouldEqual(9664.381839407506, 1e-7);
            solution.U(t0).normalized.ShouldEqual(new V3(0.77936242810570966, -0.56640344307712909, 0.26792040856856347), 1e-7);
        ...
        public void TheStandardGuidedUpperFree()
        {
            ...
            solution.U(t0).normalized.ShouldEqual(new V3(0.77953530499830737, -0.56621745928946121, 0.26781056188467101), 1e-7);
