...
namespace MechJebLibTest.PDGTests.AscentTests
{
    public class Titan2Tests
    {
        ...
        public void FlightPathAngle4Elliptical()
        {
            ...
            Optimizer      pdg      = ascent.GetOptimizer() ?? throw new Exception("null optimzer");
            using Solution solution = pdg.Solution ?? throw new Exception("null solution");
            ...
            pdg.PrimalFeasibility.ShouldBeZero(1e-8);
            ...
            argpf.ShouldEqual(1.7643342507444935, 1e-3);
        ...
        public void FlightPathAngle3EnergyElliptical()
        {
            ...
            pdg.PrimalFeasibility.ShouldBeZero(1e-8);
            smaf.ShouldEqual(8616511.1913318466, 1e-2);
            eccf.ShouldEqual(0.23913520746130185, 1e-2);
            incf.ShouldEqual(incT, 1e-7);
            lanf.ShouldEqual(Deg2Rad(270), 1e-4);
            argpf.ShouldEqual(1.7643342507444935, 1e-3);
            tanof.ShouldBeZeroRadians(1e-7);
        ...
        public void Kepler3Elliptical()
        {
            ...
            solution.U(0).normalized.ShouldEqual(new V3(0.67311315112262493, 0.64198533000545521, 0.36711513431559445), 1e-3);

            pdg.PrimalFeasibility.ShouldBeZero(1e-7);
            smaf.ShouldEqual(8616511.1913318466, 1e-7);
            eccf.ShouldEqual(0.23913520746130185, 1e-7);
            incf.ShouldEqual(incT, 1e-7);
            lanf.ShouldEqual(Deg2Rad(270), 1e-3);
            argpf.ShouldEqual(1.6625138637074874, 1e-3);
            ClampPi(tanof).ShouldEqual(0.095809701921327317, 1e-3);
        }
...
/*
        ...
        public void Kepler3ExtremeElliptical()
        {
            ...
            Optimizer      pdg      = ascent.GetOptimizer() ?? throw new Exception("null optimizer");
            using Solution solution = pdg.Solution ?? throw new Exception("null solution");
            ...
            solution.U(0).normalized.ShouldEqual(new V3(0.87754205429590737, 0.029189246151212624, 0.47861041657202014), 1e-7);
        ...
        */
        ...
        public void Circular()
        {
            ...
            pdg.PrimalFeasibility.ShouldBeZero(1e-5);
            solution.Vgo(0).ShouldEqual(8518.1366714811684, 1e-3);

            solution.U(0).normalized.ShouldEqual(new V3(0.69734975209707417, 0.6074944955387559, 0.38033374967291772), 1e-3);
        ...
        public void CircularOptimizedBooster()
        {
            ...
            Ascent ascent = Ascent.Builder()
                .AddStageUsingThrust(157355.487476332, 2340000, 301.817977905273, 148.102380138703, 4, 4, true)
                .AddStageUsingThrust(32758.6353093992, 456100.006103516, 315.000112652779, 178.63040653022, 3, 3, false)
                .Initial(r0, v0, r0.normalized, t0, mu, rbody)
                .SetTarget(PeR, ApR, PeR, incT, Deg2Rad(270), 0, false, false)
                .Build();
            ...
            solution.U(0).normalized.ShouldEqual(new V3(0.71091349069509358, 0.58674209774568975, 0.38773150436958898), 1e-3);
        ...
        public void CircularCoast()
        {
            ...
            solution.Tgo(solution.T0, 1).ShouldEqual(46.192475615255354, 1e-6);
            solution.Tgo(solution.T0, 2).ShouldBePositive();

            solution.U(0).normalized.ShouldEqual(new V3(0.67428533585626949, 0.64038742246275127, 0.36775431336792186), 1e-3);
        ...
        public void CircularCoastOptimizedBooster()
        {
            ...
            solution.Tgo(solution.T0, 0).ShouldBePositive();
            solution.Tgo(solution.T0, 1).ShouldEqual(14.925625565734082, 1e-6);
            solution.Tgo(solution.T0, 2).ShouldBePositive();
            ...
            solution.U(0).normalized.ShouldEqual(new V3(0.70743037652982543, 0.59217914188368692, 0.38583173311790908), 1e-3);
