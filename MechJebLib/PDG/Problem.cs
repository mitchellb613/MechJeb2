...
namespace MechJebLib.PDG
{
    ...
    {
        public enum ProblemCost { MAX_MASS, MAX_ENERGY, MIN_THRUST_ACCEL, MIN_TIME }
        ...
        public readonly ProblemCost Cost;

        public Problem(V3 r0, V3 v0, V3 u0, double m0, double t0, double mu, double rbody, ITerminal terminal, ProblemCost cost)
        {
