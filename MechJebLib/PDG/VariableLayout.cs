namespace MechJebLib.PDG
{
    public readonly struct VariableLayout
    {
        ...
        // - 7 continuity conditions * (numPhases - 1)
        ...
        public static int NumConstraintsForPhases(int n, int k, int numPhases, Problem problem) => (9 + 4*k) * numPhases + (n-1)*numPhases*7*2 + problem.Terminal.NumConstraints;
    }
}
