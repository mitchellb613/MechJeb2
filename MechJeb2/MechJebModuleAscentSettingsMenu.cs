...
namespace MuMech
{
    public class MechJebModuleAscentSettingsMenu : DisplayModule
    {
        ...
        private void ShowAscentSettingsGUIElements()
        {
            ...
            if (_ascentSettings.AscentType != AscentType.PDG) Core.Thrust.LimitThrottleInfoItem();
            Core.Thrust.LimiterMinThrottleInfoItem();
            if (_ascentSettings.AscentType != AscentType.PDG) Core.Thrust.LimitElectricInfoItem();
            ...
            if (_ascentSettings.AscentType != AscentType.PDG)
            {
                ...
                _ascentSettings.LimitQaEnabled = false; // this is only for PDG
            }
