...
namespace MuMech
{
    public class MechJebModuleAscentPDGAutopilot : MechJebModuleAscentBaseAutopilot
    {
        public MechJebModuleAscentPDGAutopilot(MechJebCore core) : base(core)
        {
        }
        ...
        {
            if (Core.Guidance.Status == PDGStatus.FINISHED)
            {
