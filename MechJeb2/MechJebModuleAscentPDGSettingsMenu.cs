...
namespace MuMech
{
    public class MechJebModuleAscentPDGSettingsMenu : DisplayModule
    {
        public MechJebModuleAscentPDGSettingsMenu(MechJebCore core) : base(core)
        {
            Hidden = true;
        }
        ...
        protected override void WindowGUI(int windowID)
        {
            ...
            GuiUtils.ToggledTextBox(ref _ascentSettings.StagingTriggerFlag, "PDG After Stage:", _ascentSettings.StagingTrigger, width: 40);
        ...
        public override string GetName() => "PDG Settings";

        public override string IconName() => "PDGSettings";
    }
}
