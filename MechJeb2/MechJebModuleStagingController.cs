...
namespace MuMech
{
    public class MechJebModuleStagingController : ComputerModule
    {
        ...
        public override void OnUpdate()
        {
            ...
            // this is for PDG preventing staging doing coasts, possibly it should be more specific of an API
            // (e.g. bool PDGIsCoasting) since it is getting tightly coupled.
